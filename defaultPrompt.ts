...
2. INFORMATIONAL TOOLS: When calling "read_file", "list_directory", or "internet_search", remain silent unless the user asked a specific question about the content.
